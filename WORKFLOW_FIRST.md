...
Aktualny kierunek: `0.8.28 RTS Forest Optimization` - lekka niskopoligonowa osada epoki kamienia / wczesnego sredniowiecza z Idolem, ludzmi, praca, zasobami, lowami, miesem, rybami, skorami, drewnem, kamieniem, pierwszymi rudami, palisada, brama osady, slady przy sciezkach, przeprawami przez rzeke, narzedziami kamiennymi, jeleniami, aktywnymi malymi GLB rekwizytami, proceduralnie teksturowanym terenem, ciaglejsza rzeka, organiczne plamy ziemi, pofaldowana siatka terenu, cienie pod ludzmi i obiektami, ciezszy horyzont/tlo, mniej czerwone dachy, brudny plac oraz lasem RTS z kępami smuklych iglakow zamiast kulistych drzew wklejonych pojedynczo.

Najnowsze passy Kontenera A polaczyly `0.8.19 Hunt and Hides`, `0.8.20 Living World`, `0.8.21 Living Camp Props`, `0.8.22 Textured Climate`, `0.8.23 Realistic Visual Pass`, `0.8.24 Organic World Pass`, `0.8.25 Grounded Settlement Pass`, `0.8.26 Earth and Shelter Polish`, `0.8.27 Resource Infrastructure` i `0.8.28 RTS Forest Optimization`: palisade/gate, podworka chat, legowiska, stosy drewna, przeprawy, slady stop, strefe obrobki skor, realne lekkie rekwizyty GLB, mgielke tla, teksturowane materialy ziemi/trawy/drewna/kamienia/wody, mocniejsze brzegi rzeki, kominy i dym z chat, cieplejsze ogniska, ciemne szklane UI, ciagla siatke rzeki, organiczne owalne warstwy terenu, pofaldowana baze ziemi, tlo z niskimi grzbietami, cienie pod ludzmi i obiektami, przygaszone dachy, zloza surowcow, lowiska, oboz drwali, chate mysliwego, chate rybacka, kamieniolom, kopalnie, HUD/menu pod gospodarke surowcowa, a teraz takze zgrupowany las RTS oparty o `MultiMeshInstance3D`, mniejsza gestosc dekoracji na Androidzie i mniej przypadkowej drobnicy. Kontenery B/C/D/E maja po pullu sprawdzic swoje pliki zadan w `docs/container_tasks/`.

Przy zwyklym update na Androidzie nadal nie kasuj `.godot/` i nie uzywaj `git stash -u`; ta baza zostawia import/cache w spokoju, zeby Godot na telefonie nie musial za kazdym razem mielic wszystkiego od nowa.
